...
bool VkAtlas::initialize(VkContext& ctx)
{
    ...
    {
        MEGACITYCODE_LOG_ERROR(LogCategory::Renderer, "Failed to create atlas command pool");
        return false;
    }
    ...
    {
        MEGACITYCODE_LOG_ERROR(LogCategory::Renderer, "Failed to create atlas image");
        return false;
    }
    ...
    {
        MEGACITYCODE_LOG_ERROR(LogCategory::Renderer, "Failed to create atlas image view");
        return false;
    }
    ...
    {
        MEGACITYCODE_LOG_ERROR(LogCategory::Renderer, "Failed to create atlas sampler");
        return false;
    }
...
bool VkAtlas::ensure_staging_capacity(VkContext& ctx, size_t required_size)
{
    return ensure_buffer_size(staging_, required_size, [&](size_t requested_size, BufferState& replacement) {
            ...
            {
                MEGACITYCODE_LOG_ERROR(LogCategory::Renderer, "Failed to create atlas staging buffer");
                return false;
            }
