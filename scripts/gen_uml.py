...
def ensure_tools_build_configured(repo_root: Path, dry_run: bool) -> None:
    """Ensure build-tools/ exists with compile_commands.json (Ninja preset)."""
    compile_commands = repo_root / "build-tools" / "compile_commands.json"
    if compile_commands.exists():
        return
    print("No build-tools/ compile_commands.json found. Configuring with Ninja (clang-tools preset)...")
